...
If you are using Windows, add these lines in the database.yml file under both the development and test code blocks. If you're using mac and they are already there, delete these lines.
