...
const HomePage = (props) => {
  ...
  return (
    <div className="home-page">
      ...
      <p>DISCLAIMER: This app is deployed to heroku, which is a free server. The trade off is it's super slow and laggy, and thus notoriously bad for animations (unaware to me until I did research after deploying). After a game ends, there is an animation displaying who won. But due to random factors like internet speed and traffic, it will often lag to the last frame. Sometimes some animations don't lag, but others do (there is a different animation depending on the final piece moved and which color won). This is an issue that only happens on the free version of heroku, so I didn't want to remove them because they work perfectly in all other contexts, took a lot of time and effort, and will still work here if the heroku servers don’t seem to be under too much stress.</p>
    </div>
  )
}
